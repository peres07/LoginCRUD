    ...
    <Container>
      <Row>
        <Col className='background'>
          ...
          <Form className='inside-container d-grid gap-3' onSubmit={onSubmit} ref={formRef}>
            <Form.Group className='inputs d-grid gap-2'>
              <Col>
                <Form.Label htmlFor='email'>E-Mail:</Form.Label>
                <Form.Control type='email' id='email' ref={emailRef} required={true} />
              </Col>
              <Col>
                <Form.Label htmlFor='username'>Username:</Form.Label>
                <Form.Control type='text' id='username' ref={usernameRef} required={true} />
              </Col>
              <Col>
                <Form.Label htmlFor='password'>Password:</Form.Label>
                <Form.Control type='password' id='password' ref={passwordRef} required={true} />
              </Col>
            ...
            <Col className='text-center'>
              <a href='/login' className='login-label text-decoration-none'>
                Login Now!
              </a>
            </Col>
          </Form>
